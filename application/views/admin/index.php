    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1"><a href="<?= base_url('Sub_Kriteria'); ?>" class="text-info">
                            Subkriteria</a></div>
...
<?php if($this->session->userdata('id_user_level') == '2'): ?>
    ...
    <div class="d-sm-flex align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-info">Hallo,</h6>
	    <h5 class="card-text"><small class="text-muted text-info"><?php date_default_timezone_set("Asia/Jakarta"); echo date("d-M-Y")?></small></h5>
    </div>
    </div>
    <div class="card-body">
        <p class="mb-0 text-dark">
