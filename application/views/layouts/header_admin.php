...
<?php if($this->session->userdata('id_user_level') == '1'): ?>
    ...
    <div class="sidebar-heading">
        MENU
                ...
                <li class="nav-item 
                <?php if($page=='Alternatif'){echo 'active';}?>
                <?php if($page=='Penilaian'){echo 'active';}?>">
    ...
    <li class="nav-item 
          <?php if($page=='Kriteria'){echo  'active';}?>
          <?php if($page=='Sub Kriteria'){echo 'active';}?>">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="<?= base_url('Sub_Kriteria'); ?>">Subkriteria</a>
        </div>
      </div>
    </li>
    ...
    <hr class="sidebar-divider mb-2">
	  ...
	  <li class="nav-item mb-2 <?php if($page=='Hasil'){echo 'active';}?>">
        <a class="nav-link" href="<?= base_url('Perhitungan/hasil'); ?>">
          <i class="fas fa-fw fa-file"></i>
          <span>Laporan </span></a>
      </li>	
    ...
    <hr class="sidebar-divider mb-0">
      ...
      <li class="nav-item mb-0 <?php if($page=='Alternatif'){echo 'active';}?>">
