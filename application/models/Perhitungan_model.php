...
class Perhitungan_model extends CI_Model
{
	...
	{
		$get = $this->db->get_where('publish', ['id' => 1])->row_array();
	...
	public function publish($nilai)
	{
		// delete
		$this->db->where('id', 1)->delete('publish');
		...
		$insert = $this->db->insert('publish', $get);
